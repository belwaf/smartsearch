 ...
 */
	public function testRedirectSet() {
		$value = array('controller' => 'profiles', 'action' => 'home');
		$result = $this->Auth->redirectUrl($value);
		$this->assertEquals('/profiles/home', $result);
 ...
 */
	public function testRedirectSessionRead() {
		$this->Auth->loginAction = array('controller' => 'profiles', 'action' => 'login');
		$this->Auth->Session->write('Auth.redirect', '/profiles/home');
 ...
 */
	public function testRedirectSessionReadEqualToLoginAction() {
		$this->Auth->loginAction = array('controller' => 'profiles', 'action' => 'login');
		$this->Auth->loginRedirect = array('controller' => 'profiles', 'action' => 'home');
		$this->Auth->Session->write('Auth.redirect', array('controller' => 'profiles', 'action' => 'login'));
