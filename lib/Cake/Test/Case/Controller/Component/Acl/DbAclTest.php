 ...
 */
	public function testAllow() {
		...
		$this->assertFalse($this->Acl->check('root/profiles/Samir', 'ROOT/tpsReports/view'));
		$this->assertTrue($this->Acl->allow('root/profiles/Samir', 'ROOT/tpsReports/view', '*'));
		$this->assertTrue($this->Acl->check('Samir', 'view', 'read'));
		$this->assertTrue($this->Acl->check('root/profiles/Samir', 'ROOT/tpsReports/view', 'update'));

		$this->assertFalse($this->Acl->check('root/profiles/Samir', 'ROOT/tpsReports/update', '*'));
		$this->assertTrue($this->Acl->allow('root/profiles/Samir', 'ROOT/tpsReports/update', '*'));
		$this->assertTrue($this->Acl->check('Samir', 'update', 'read'));
		$this->assertTrue($this->Acl->check('root/profiles/Samir', 'ROOT/tpsReports/update', 'update'));
 ...
 */
	public function testCheck() {
		...
		$this->assertFalse($this->Acl->check('root/profiles/Milton', 'smash', 'delete'));
	}
 ...
 */
	public function testCheckMissingPermission() {
		$this->Acl->check('profiles', 'NonExistent', 'read');
	}
 ...
 */
	public function testAclNodeLookup() {
		$result = $this->Acl->Aro->node('root/profiles/Samir');
		$expected = array(
			array('AroTwoTest' => array('id' => '7', 'parent_id' => '4', 'model' => 'User', 'foreign_key' => 3, 'alias' => 'Samir')),
			array('AroTwoTest' => array('id' => '4', 'parent_id' => '1', 'model' => 'Group', 'foreign_key' => 3, 'alias' => 'profiles')),
 ...
 */
	public function testRevoke() {
		...
		$this->assertTrue($this->Acl->check('profiles', 'printers', 'read'));
		$this->Acl->deny('profiles', 'printers', 'read');
		$this->assertFalse($this->Acl->check('profiles', 'printers', 'read'));
