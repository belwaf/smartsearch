 ...
 */
	public function testAroAliases() {
		...
		// Role/default is allowed profiles dashboard, but not Role/IT
		$this->assertFalse($this->Acl->check($user, '/controllers/profiles/dashboard'));
 ...
 */
	public function testCheck() {
		$this->assertTrue($this->Acl->check('jan', '/controllers/profiles/Dashboard'));
		$this->assertTrue($this->Acl->check('some_unknown_role', '/controllers/profiles/Dashboard'));
		...
		$this->assertFalse($this->Acl->check('db_manager_2', '/controllers/profiles/Dashboard'));
