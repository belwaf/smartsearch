 ...
 */
	public function testCounterCacheUpdated() {
		...
		$profiles = $User->find('all', array('order' => 'User.id'));
		$this->assertEquals(1, $profiles[0]['User']['post_count']);
		$this->assertEquals(2, $profiles[1]['User']['post_count']);
	}
 ...
 */
	public function testCounterCacheWithNonstandardPrimaryKey() {
		...
		$profiles = $User->find('all', array('order' => 'User.uid'));
		$this->assertEquals(1, $profiles[0]['User']['post_count']);
		$this->assertEquals(2, $profiles[1]['User']['post_count']);
	}
