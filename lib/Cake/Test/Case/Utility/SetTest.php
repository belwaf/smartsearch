 ...
 */
	public function testMerge() {
		...
		$a = array('profiles' => array('bob', 'jim'));
		$b = array('profiles' => array('lisa', 'tina'));
		$this->assertEquals(array('profiles' => array('bob', 'jim', 'lisa', 'tina')), Set::merge($a, $b));

		$a = array('profiles' => array('jim', 'bob'));
		$b = array('profiles' => 'none');
		$this->assertEquals(array('profiles' => 'none'), Set::merge($a, $b));

		$a = array('profiles' => array('lisa' => array('id' => 5, 'pw' => 'secret')), 'cakephp');
		$b = array('profiles' => array('lisa' => array('pw' => 'new-pass', 'age' => 23)), 'ice-cream');
		$this->assertEquals(array('profiles' => array('lisa' => array('id' => 5, 'pw' => 'new-pass', 'age' => 23)), 'cakephp', 'ice-cream'), Set::merge($a, $b));

		$c = array('profiles' => array('lisa' => array('pw' => 'you-will-never-guess', 'age' => 25, 'pet' => 'dog')), 'chocolate');
		$expected = array('profiles' => array('lisa' => array('id' => 5, 'pw' => 'you-will-never-guess', 'age' => 25, 'pet' => 'dog')), 'cakephp', 'ice-cream', 'chocolate');
 ...
 */
	public function testSort() {
		...
		$menus = array(
			...
			'profiles' => array('title' => 'profiles', 'weight' => 1),
			);
		$expected = array(
			'profiles' => array('title' => 'profiles', 'weight' => 1),
			'comments' => array('title' => 'Comments', 'weight' => 2),
 ...
 */
	public function testCombine() {
		...
		$b->profiles = array(
			...
			array('User' => array('id' => 25, 'group_id' => 1,
				'Data' => array('user' => 'gwoo', 'name' => 'The Gwoo'))));
		$result = Set::combine($b, 'profiles.{n}.User.id');
		$expected = array(2 => null, 14 => null, 25 => null);
		$this->assertEquals($expected, $result);

		$result = Set::combine($b, 'profiles.{n}.User.id', 'profiles.{n}.User.non-existant');
		$expected = array(2 => null, 14 => null, 25 => null);
		$this->assertEquals($expected, $result);
	...
	public function testXmlSetReverse() {
		...
		$expected = array('rss' => array(
			...
			'channel' => array(
				...
				'description' => 'Search this group before posting anything. There are over 20,000 posts and it&#39;s very likely your question was answered before. Visit the IRC channel #cakephp at irc.freenode.net for live chat with profiles and developers of Cake. If you post, tell us the version of Cake, PHP, and database.',
				'language' => 'en',
				'item' => array(
					array(
