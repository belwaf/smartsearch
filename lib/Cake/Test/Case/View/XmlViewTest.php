 ...
 */
	public function testRenderWithoutView() {
		...
		$data = array('profiles' => array('user' => array('user1', 'user2')));
		$Controller->set(array('profiles' => $data, '_serialize' => 'profiles'));
		...
		$expected = Xml::build(array('response' => array('profiles' => $data)))->asXML();
		...
		$expected = Xml::build(array('custom_name' => array('profiles' => $data)))->asXML();
		$this->assertSame($expected, $output);
	}
 ...
 */
	public function testRenderWithView() {
		...
		$expected = array(
			'profiles' => array('user' => array('user1', 'user2'))
		);
