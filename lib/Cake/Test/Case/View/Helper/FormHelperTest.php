 ...
 */
	public function testInputSelectType() {
		...
		$this->View->viewVars['profiles'] = array('value' => 'good', 'other' => 'bad');
 ...
 */
	public function testCreate() {
		...
		$expected = array(
			'form' => array(
				'id' => 'UserSignupForm', 'method' => 'post', 'action' => '/profiles/signup',
				'accept-charset' => $encoding
			),
			'div' => array('style' => 'display:none;'),
			'input' => array('type' => 'hidden', 'name' => '_method', 'value' => 'POST'),
 ...
 */
	public function testCreateCustomRoute() {
		Router::connect('/login', array('controller' => 'profiles', 'action' => 'login'));
		$encoding = strtolower(Configure::read('App.encoding'));
