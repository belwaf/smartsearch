 ...
 */
	public function testSortAdminLinks() {
		...
		Router::reload();
		Router::setRequestInfo(array(
			array('pass' => array(), 'named' => array(), 'controller' => 'profiles', 'plugin' => null, 'action' => 'admin_index', 'prefix' => 'admin', 'admin' => true, 'url' => array('ext' => 'html', 'url' => 'admin/profiles')),
			array('base' => '', 'here' => '/admin/profiles', 'webroot' => '/')
		));
		Router::parse('/admin/profiles');
		$this->Paginator->request->params['paging']['Article']['page'] = 1;
		$result = $this->Paginator->next('Next');
		$expected = array(
			'span' => array('class' => 'next'),
			'a' => array('href' => '/admin/profiles/index/page:2', 'rel' => 'next'),
			'Next',
			'/a',
			'/span'
		);
