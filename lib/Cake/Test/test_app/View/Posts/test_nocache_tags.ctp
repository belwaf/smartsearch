...
<p>
<?php echo __d('cake', 'Our primary goal is to provide a structured framework that enables PHP profiles at all levels to rapidly develop robust web applications, without any loss to flexibility.'); ?>
</p>
<ul>
