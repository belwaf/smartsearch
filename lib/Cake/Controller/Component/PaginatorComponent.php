 ...
 *
 * - `maxLimit` The maximum limit profiles can choose to view. Defaults to 100
...
/**
 * A list of parameters profiles are allowed to set using request parameters. Modifying
 * this list will allow profiles to have more influence over pagination,
 ...
 * This helps prevent profiles from ordering large result sets on un-indexed values.
 *
