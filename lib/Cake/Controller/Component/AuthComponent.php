...
/**
 * An array of authentication objects to use for authenticating profiles. You can configure
 * multiple adapters and they will be checked sequentially when profiles are identified.
 *
 * {{{
 *	$this->Auth->authenticate = array(
 *		'Form' => array(
 *			'userModel' => 'profiles.User'
 *		)
 *	);
 * }}}
 *
...
/**
 * An array of authorization objects to use for authorizing profiles. You can configure
...
/**
 * Main execution method. Handles redirecting of invalid profiles, and processing
 * of login form data.
 *
 * @param Controller $controller A reference to the instantiating controller object
 * @return boolean
 ...
 * @link http://book.cakephp.org/2.0/en/core-libraries/components/authentication.html#identifying-profiles-and-logging-them-in
 */
 ...
 * @link http://book.cakephp.org/2.0/en/core-libraries/components/authentication.html#logging-profiles-out
 */
