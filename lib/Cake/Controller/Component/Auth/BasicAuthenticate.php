 ...
 *
 * Provides Basic HTTP authentication support for AuthComponent. Basic Auth will authenticate profiles
 * against the configured userModel and verify the username and passwords match. Clients using Basic Authentication
 * must support cookies. Since AuthComponent identifies profiles based on Session contents, clients using Basic
 ...
 * - `scope` Additional conditions to use when looking up and authenticating profiles,
