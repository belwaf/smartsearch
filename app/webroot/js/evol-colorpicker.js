...
$.widget( "evol.colorpicker", {
		...
		switch(this.element.get(0).tagName){
			case 'INPUT':
				...
				e.addClass('colorPicker '+this._id)
					.after('<i class="glyphicon glyphicon-fire" aria-hidden="true" style="background-color:none"></i>')
	...
	_paletteHTML: function() {
		...
		var h='<div class="evo-pop'+_ie+' ui-widget ui-widget-content ui-corner-all"'+
			(this._isPopup?' style="position:fixed; margin-top:-200px;margin-left:-200px"':'')+'>'+
			// palette
