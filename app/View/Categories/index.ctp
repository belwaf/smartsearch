...
<div ba-panel="" ba-panel-title="Standard Fields" ba-panel-class="with-scroll">
    ...
    <div class="panel-heading clearfix"><h3 class="panel-title"><?php echo __('Category'); ?></h3>
    </div>
    <div class="panel">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__(''), array('action' => 'edit', $category['Category']['id']),array('class'=>'fa fa-pencil')); ?>
			<?php echo $this->Form->postLink(__(''), array('action' => 'delete', $category['Category']['id']), array('class'=>'fa fa-trash'), __('Are you sure you want to delete # %s?', $category['Category']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
